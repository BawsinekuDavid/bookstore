            ...
            <form onSubmit={handleSubmit} className="text-center">
              <div className="form-outline mb-4">
                <input 
                  type="text" 
                  id="form3Example1" 
                  className={`form-control form-control-lg text-black ${errors.name ? 'is-invalid' : ''}`} 
              ...
              <p className="small fw-bold mt-2 pt-1 mb-0">Already have an account? <button type="button" className="btn btn-link link-danger" onClick={() => navigate('/login')}>Login</button></p>
            </form>
          </div>
        </div>
      </div>
